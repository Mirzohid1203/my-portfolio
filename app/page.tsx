...
export default function Home() {
      ...
      <div className="flex items-center justify-center min-h-screen bg-black text-white px-6 text-center">
        {data?.error ? (
          <div>
            ...
            <p className="text-sm mt-4 text-white/20">Firebase qoidalari (Rules) ochiq ekanligiga ishonch hosil qiling.</p>
          </div>
        ) : (
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-purple-500/30">
      ...
      <footer className="py-8 text-center text-muted-foreground text-sm border-t border-white/10 bg-black">
